<?php
/*
Startup Slider Hero Mailchimp Subscriber form
*/
?>
<div class="mailchimp">
	<div class="subcribe">
...
<?php
/*
Saas Hero Mailchimp Subscriber form
*/
?>
...
<?php
/*
(Single Individual) App Landing Pages Subscriber Form
*/
?>
...
<?php
/*
(Single Individual) SEO Pages Subscriber Form
*/
?>
<div class="input-group  subcribes-two">
  <input type="email" name="EMAIL" class="form-control memail" placeholder="Enter your email">
  <span class="input-group-btn">
    <button class="btn btn-default btn-submit" type="submit">subscribe</button>
  </span>
...
<?php
/*
(To Use Single Individually) Startup Slider Page Subscriber Form
*/
?>
<div class="slider-text st-slider-text">
  <div class="subcribe">
    <input type="email" name="EMAIL" id="reg_email" class="form-control memail" placeholder="Enter your email...">
    <label>
      <button class="btn sub_btn sub_btn-two" type="submit">subscribe</button>
...
<?php
/*
(To Use Single Individually) Saas Page Subscriber Form
*/
?>
